...
console.log(addflavor(array, "Rainbow Sherbert"))
...
console.log(removeFlavorByName(array))
...
console.log(getFlavorByIndex(array, 2))
...
console.log(removeFlavorByName(array, "Rocky Road"))
    ...
    let filtered = [];
     for (var i = 0; i < originalFlavors.length; i++){
       if (originalFlavors[i].includes(search)){
         filtered.push(originalFlavors[i])
       }
     }
     return filtered
  }
  console.log(filterByWord(originalFlavors, "Chocolate"))
//Forgot to fork the git, had to delete file, redownload, and paste back in, but now it isnt showing anything changed, so heres a change lol
